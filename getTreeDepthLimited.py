...
def getTree(attrOutputList,root_node,depth,DEPTH_LIMIT):
    ...
    for attr in containerOutputCList['ResourceOutput'][0]['Attributes']:
        if(attr['attributeName'] == 'child-container List'):
            ...
            #If Child-Container List is empty - break
            ...
            for container in containerList:
                ...
                if(numContainer == '1'):
                    print container[1:-1]
                    getTree(attrOutputList,container[1:-1], depth,DEPTH_LIMIT)
                    continue
                #First container -> remove [
                if(count == 1):
                    print container[1:] #TEST
                    getTree(attrOutputList,container[1:], depth,DEPTH_LIMIT)
                    continue
                ...
                getTree(attrOutputList,container, depth, DEPTH_LIMIT)
    ...
    for attr in containerOutputCList['ResourceOutput'][0]['Attributes']:
        if(attr['attributeName'] == 'child-contentInstance List'):
            print attr['attributeValue']
            #If child-contentInstance List is empty - break
            if(attr['attributeValue'] == '[]'):
                break
            ...
            for contentInstance in contentInstanceList:
                ...
                if(numContentInstance == '1'):
                    ...
                    getContentInstance(attrOutputList,contentInstance[1:-1], depth+1,DEPTH_LIMIT)
                    return
                #First contentInstance -> remove [
                if(count == 1):
                    print contentInstance[1:] #TEST
                    getContentInstance(attrOutputList,contentInstance[1:],depth+1,DEPTH_LIMIT)
                    continue
                ...
                getContentInstance(attrOutputList,contentInstance,depth+1,DEPTH_LIMIT)
...
def getContentInstance(attrOutputList,contentInstancePath, depth,DEPTH_LIMIT):
    if(depth == DEPTH_LIMIT):
        return
